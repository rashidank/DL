...
def tumor_detection(img, model):
    ...
    return "Tumor Detected" if res[0][0]<res[0][1] else "No Tumor"

# Streamlit App
st.title("Prediction Using Deep Learning")

# Choose between tasks
task = st.radio("Choose one", ("Sentiment Classification", "Tumor Detection"))
...
if task == "Sentiment Classification":
    ...
    if new_review_text.strip():
        ...
        if model_option == "Perceptron":
            with open(r'Perceptron\model_1_perceptron.pkl', 'rb') as file:
